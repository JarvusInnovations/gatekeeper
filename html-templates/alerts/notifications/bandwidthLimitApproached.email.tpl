...
{capture assign=subject}
    ...
    -- Bandwidth limit will be reached
    {if $Alert->Status == 'open'}
        with {$bucket.hits} bytes in {$bucket.seconds|number_format}s
    {/if}
{/capture}
